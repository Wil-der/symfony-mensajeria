...
class getMessenger_Bus_Default_Middleware_SendMessageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['.service_locator.2Koikl3'] ?? $container->load('get_ServiceLocator_2Koikl3Service'));
        ...
        $container->privates['messenger.bus.default.middleware.send_message'] = $instance = new \Symfony\Component\Messenger\Middleware\SendMessageMiddleware(new \Symfony\Component\Messenger\Transport\Sender\SendersLocator(['App\\Envio\\Message\\ReasignarEnvioMessage' => ['async'], 'App\\Envio\\Message\\NotificarAsignacionMessage' => ['async'], 'App\\Tracking\\Message\\FlushUbicacionesMessage' => ['async'], 'App\\Shared\\Message\\EnviarNotificacionMessage' => ['async'], 'App\\Envio\\Message\\EstadoEnvioChangedMessage' => ['async']], $a), $b, true);
