...
{
    /**
     * Gets the private 'App\Auth\Repository\PasswordResetTokenRepository' shared autowired service.
     *
     * @return \App\Auth\Repository\PasswordResetTokenRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Auth/Repository/PasswordResetTokenRepository.php';

        return $container->privates['App\\Auth\\Repository\\PasswordResetTokenRepository'] = new \App\Auth\Repository\PasswordResetTokenRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
