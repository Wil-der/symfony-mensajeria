...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Mensajero\\Controller\\MensajeroController' => 'getMensajeroControllerService',
    ...
    protected static function get_Container_Private_ProfilerService($container)
    {
        ...
        $instance->add(new \Symfony\Component\Workflow\DataCollector\WorkflowDataCollector(new RewindableGenerator(function () use ($container) {
            yield 'envio' => ($container->privates['debug.state_machine.envio'] ?? self::getDebug_StateMachine_EnvioService($container));
    ...
    protected static function getApiPlatform_StateProvider_ParameterValidatorService($container)
    {
        ...
        return $container->services['api_platform.state_provider.parameter_validator'] = new \ApiPlatform\Symfony\Validator\State\ParameterValidatorProvider($a, new \ApiPlatform\State\Provider\ReadProvider($b, $c, ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\RedisAdapter(($container->privates['.cache_connection.vRXud1c'] ?? self::get_CacheConnection_VRXud1cService($container)), 'eyioqXDD-O', 0, ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\RedisAdapter(($container->privates['.cache_connection.vRXud1c'] ?? self::get_CacheConnection_VRXud1cService($container)), '9yZWsDqxg6', 0, ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['logger'] ?? self::getLoggerService($container)));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\ApcuAdapter('k6Cnmu8mHx', 0, $container->getParameter('container.build_id'));
        $a->setLogger(($container->privates['logger'] ?? self::getLoggerService($container)));

        return $container->services['cache.security_is_csrf_token_valid_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter($a);
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\ApcuAdapter('hmJA5rYfeU', 0, $container->getParameter('container.build_id'));
        $a->setLogger(($container->privates['logger'] ?? self::getLoggerService($container)));

        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter($a);
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\ApcuAdapter('M0c74nH75t', 0, $container->getParameter('container.build_id'));
        $a->setLogger(($container->privates['logger'] ?? self::getLoggerService($container)));

        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter($a);
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\ApcuAdapter('slcs7MOkIJ', 0, $container->getParameter('container.build_id'));
        $a->setLogger(($container->privates['logger'] ?? self::getLoggerService($container)));

        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter($a);
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $d = ($container->privates['doctrine.orm.default_xml_metadata_driver'] ?? self::getDoctrine_Orm_DefaultXmlMetadataDriverService($container));

        $b->addDriver($c, 'App\\Auth\\Entity');
        $b->addDriver($c, 'App\\Mensajero\\Entity');
        $b->addDriver($c, 'App\\Envio\\Entity');
        $b->addDriver($c, 'App\\Tracking\\Entity');
        $b->addDriver($c, 'App\\Chat\\Entity');
        $b->addDriver($c, 'App\\Pago\\Entity');
        $b->addDriver($d, 'Gesdinet\\JWTRefreshTokenBundle\\Entity');
        $b->addDriver($d, 'Vich\\UploaderBundle\\Entity');

        $a->setEntityNamespaces(['Auth' => 'App\\Auth\\Entity', 'Mensajero' => 'App\\Mensajero\\Entity', 'Envio' => 'App\\Envio\\Entity', 'Tracking' => 'App\\Tracking\\Entity', 'Chat' => 'App\\Chat\\Entity', 'Pago' => 'App\\Pago\\Entity', 'GesdinetJWTRefreshTokenBundle' => 'Gesdinet\\JWTRefreshTokenBundle\\Entity', 'VichUploaderBundle' => 'Vich\\UploaderBundle\\Entity']);
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Admin\\Repository\\ConfiguracionRepository' => ['privates', 'App\\Admin\\Repository\\ConfiguracionRepository', 'getConfiguracionRepositoryService', true],
            'App\\Auth\\Repository\\PasswordResetTokenRepository' => ['privates', 'App\\Auth\\Repository\\PasswordResetTokenRepository', 'getPasswordResetTokenRepositoryService', true],
            'App\\Auth\\Repository\\RefreshTokenRepository' => ['privates', 'App\\Auth\\Repository\\RefreshTokenRepository', 'getRefreshTokenRepositoryService', true],
            'App\\Chat\\Repository\\MensajeChatRepository' => ['privates', 'App\\Chat\\Repository\\MensajeChatRepository', 'getMensajeChatRepositoryService', true],
            'App\\Envio\\Repository\\EnvioRepository' => ['privates', 'App\\Envio\\Repository\\EnvioRepository', 'getEnvioRepositoryService', true],
            'App\\Envio\\Repository\\FotoEnvioRepository' => ['privates', 'App\\Envio\\Repository\\FotoEnvioRepository', 'getFotoEnvioRepositoryService', true],
            'App\\Mensajero\\Repository\\MensajeroRepository' => ['privates', 'App\\Mensajero\\Repository\\MensajeroRepository', 'getMensajeroRepositoryService', true],
            'App\\Pago\\Repository\\CalificacionRepository' => ['privates', 'App\\Pago\\Repository\\CalificacionRepository', 'getCalificacionRepositoryService', true],
            'App\\Pago\\Repository\\FavoritoRepository' => ['privates', 'App\\Pago\\Repository\\FavoritoRepository', 'getFavoritoRepositoryService', true],
            'App\\Pago\\Repository\\PagoRepository' => ['privates', 'App\\Pago\\Repository\\PagoRepository', 'getPagoRepositoryService', true],
            'App\\Tracking\\Repository\\UbicacionMensajeroRepository' => ['privates', 'App\\Tracking\\Repository\\UbicacionMensajeroRepository', 'getUbicacionMensajeroRepositoryService', true],
        ], [
            'App\\Admin\\Repository\\ConfiguracionRepository' => '?',
            'App\\Auth\\Repository\\PasswordResetTokenRepository' => '?',
            'App\\Auth\\Repository\\RefreshTokenRepository' => '?',
            'App\\Chat\\Repository\\MensajeChatRepository' => '?',
            'App\\Envio\\Repository\\EnvioRepository' => '?',
            'App\\Envio\\Repository\\FotoEnvioRepository' => '?',
            'App\\Mensajero\\Repository\\MensajeroRepository' => '?',
            'App\\Pago\\Repository\\CalificacionRepository' => '?',
            'App\\Pago\\Repository\\FavoritoRepository' => '?',
            'App\\Pago\\Repository\\PagoRepository' => '?',
            'App\\Tracking\\Repository\\UbicacionMensajeroRepository' => '?',
        ])));
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('lexik_jwt_authentication.on_jwt_created', [#[\Closure(name: 'lexik_jwt_authentication.subscriber.access_token_time', class: 'Lexik\\Bundle\\JWTAuthenticationBundle\\Subscriber\\AdditionalAccessTokenClaimsAndHeaderSubscriber')] fn () => ($container->privates['lexik_jwt_authentication.subscriber.access_token_time'] ??= new \Lexik\Bundle\JWTAuthenticationBundle\Subscriber\AdditionalAccessTokenClaimsAndHeaderSubscriber(3600)), 'addClaims'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Mensajero\\Controller\\MensajeroController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getMessenger_DefaultBusService($container)
    {
        return $container->services['messenger.default_bus'] = new \Symfony\Component\Messenger\TraceableMessageBus(new \Symfony\Component\Messenger\MessageBus(new RewindableGenerator(function () use ($container) {
            ...
            yield 5 => ($container->privates['messenger.bus.default.middleware.doctrine_transaction'] ?? $container->load('getMessenger_Bus_Default_Middleware_DoctrineTransactionService'));
    ...
    /**
     * Gets the private '.cache_connection.vRXud1c' shared service.
     *
     * @return \Symfony\Component\Cache\Adapter\AbstractAdapter
     */
    protected static function get_CacheConnection_VRXud1cService($container)
    {
        return $container->privates['.cache_connection.vRXud1c'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createConnection($container->getEnv('REDIS_URL'), ['lazy' => true]);
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\ApcuAdapter('kkojMGl38U', 0, $container->getParameter('container.build_id'));
        $a->setLogger(($container->privates['logger'] ?? self::getLoggerService($container)));

        return $container->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter($a);
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\ApcuAdapter('G1vCWY71y6', 0, $container->getParameter('container.build_id'));
        $a->setLogger(($container->privates['logger'] ?? self::getLoggerService($container)));

        return $container->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter($a);
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\ApcuAdapter('ePuMoIV30p', 0, $container->getParameter('container.build_id'));
        $a->setLogger(($container->privates['logger'] ?? self::getLoggerService($container)));

        return $container->privates['api_platform.cache.metadata.resource_collection'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter($a);
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\ApcuAdapter('4bZZlzhLei', 0, $container->getParameter('container.build_id'));
        $a->setLogger(($container->privates['logger'] ?? self::getLoggerService($container)));

        return $container->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter($a);
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\RedisAdapter(($container->privates['.cache_connection.vRXud1c'] ?? self::get_CacheConnection_VRXud1cService($container)), 'y0jeLqCmad', 0, ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['logger'] ?? self::getLoggerService($container)));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\ApcuAdapter('VZM+4hF761', 0, $container->getParameter('container.build_id'));
        $a->setLogger(($container->privates['logger'] ?? self::getLoggerService($container)));

        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter($a);
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\ApcuAdapter('WrMLAKLXuY', 0, $container->getParameter('container.build_id'));
        $a->setLogger(($container->privates['logger'] ?? self::getLoggerService($container)));

        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter($a);
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\ApcuAdapter('af9-Z-njRL', 0, $container->getParameter('container.build_id'));
        $a->setLogger(($container->privates['logger'] ?? self::getLoggerService($container)));

        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter($a);
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\ApcuAdapter('TCFTh4Y6cc', 0, $container->getParameter('container.build_id'));
        $a->setLogger(($container->privates['logger'] ?? self::getLoggerService($container)));

        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter($a);
    }
    ...
    protected static function getDebug_SerializerService($container)
    {
        ...
        $m = ($container->privates['api_platform.router'] ?? self::getApiPlatform_RouterService($container));
        ...
        $p = new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($b, $c, $d, $e, $n, $f, $h, $l, $o, $container->parameters['api_platform.serializer.default_context'], $g, NULL);

        $q = new \ApiPlatform\JsonLd\Serializer\ErrorNormalizer($p, $container->parameters['api_platform.serializer.default_context']);
        $r = new \ApiPlatform\Serializer\ItemNormalizer($c, $d, $e, $n, $h, $l, $o, NULL, $b, $g, [], NULL);
        ...
        $u = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($o, $s, $h, $a, $t, NULL, [], $a);
        ...
        return $container->privates['debug.serializer'] = new \Symfony\Component\Serializer\Debug\TraceableSerializer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($h), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($k, $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($k, $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Serializer\ConstraintViolationListNormalizer([], $l), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($m, [], $l, $container->parameters['api_platform.serializer.default_context']), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $l, $container->parameters['api_platform.serializer.default_context']), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($k, $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($q, $l), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($b, $c, $d, $n, $m, $l, $container->parameters['api_platform.serializer.default_context']), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($b, $e, $m), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($m, true, $container->parameters['api_platform.serializer.default_context']), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($r, $l), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true, []), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($q, $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, $container->parameters['api_platform.serializer.default_context'], NULL), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UidNormalizer($container->parameters['api_platform.serializer.default_context']), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($p, $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($r, $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer($container->parameters['api_platform.serializer.default_context']), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer($container->parameters['api_platform.serializer.default_context'], $s), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($o, $s, $a, $t, NULL, [])), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer($container->parameters['api_platform.serializer.default_context']), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, $container->parameters['api_platform.serializer.default_context']), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($f, $n, $e, NULL, $container->parameters['api_platform.serializer.default_context']), 'page', 'pagination', $b, $h, 1, $container->parameters['api_platform.serializer.default_context']), $b, $n, ($container->privates['api_platform.filter_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [], [])), $container->parameters['api_platform.serializer.default_context']), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($u, $e, $f), $i), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($u, $i)], [new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\XmlEncoder($container->parameters['api_platform.serializer.default_context']), $i), new \Symfony\Component\Serializer\Debug\TraceableEncoder($j, $i), new \Symfony\Component\Serializer\Debug\TraceableEncoder($v, $i), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\CsvEncoder($container->parameters['api_platform.serializer.default_context']), $i), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), $i), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $v), $i), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), $i), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonproblem'), $i)], $container->parameters['api_platform.serializer.default_context']), $i);
    }

    /**
     * Gets the private 'debug.state_machine.envio' shared service.
     *
     * @return \Symfony\Component\Workflow\Debug\TraceableWorkflow
     */
    protected static function getDebug_StateMachine_EnvioService($container)
    {
        $a = ($container->services['event_dispatcher'] ?? self::getEventDispatcherService($container));

        if (isset($container->privates['debug.state_machine.envio'])) {
            return $container->privates['debug.state_machine.envio'];
        }

        return $container->privates['debug.state_machine.envio'] = new \Symfony\Component\Workflow\Debug\TraceableWorkflow(new \Symfony\Component\Workflow\StateMachine(new \Symfony\Component\Workflow\Definition(['pendiente', 'pagado', 'asignado', 'recogido', 'en_camino', 'entregado', 'cancelado'], [new \Symfony\Component\Workflow\Transition('pagar', 'pendiente', 'pagado'), new \Symfony\Component\Workflow\Transition('asignar', 'pagado', 'asignado'), new \Symfony\Component\Workflow\Transition('recoger', 'asignado', 'recogido'), new \Symfony\Component\Workflow\Transition('iniciar_entrega', 'recogido', 'en_camino'), new \Symfony\Component\Workflow\Transition('entregar', 'en_camino', 'entregado'), new \Symfony\Component\Workflow\Transition('cancelar', 'pendiente', 'cancelado'), new \Symfony\Component\Workflow\Transition('cancelar', 'pagado', 'cancelado'), new \Symfony\Component\Workflow\Transition('cancelar', 'asignado', 'cancelado'), new \Symfony\Component\Workflow\Transition('cancelar', 'recogido', 'cancelado'), new \Symfony\Component\Workflow\Transition('cancelar', 'en_camino', 'cancelado')], ['pendiente'], new \Symfony\Component\Workflow\Metadata\InMemoryMetadataStore([], [], new \SplObjectStorage())), new \Symfony\Component\Workflow\MarkingStore\MethodMarkingStore(true, 'marking'), $a, 'envio', NULL), ($container->services['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true)));
    }
    ...
    {
        return $container->privates['doctrine.orm.default_attribute_metadata_driver'] = new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Auth/Entity'), (\dirname(__DIR__, 4).'/src/Mensajero/Entity'), (\dirname(__DIR__, 4).'/src/Envio/Entity'), (\dirname(__DIR__, 4).'/src/Tracking/Entity'), (\dirname(__DIR__, 4).'/src/Chat/Entity'), (\dirname(__DIR__, 4).'/src/Pago/Entity')], true);
    }
    ...
    protected static function getTwigService($container)
    {
        ...
        $e->addWorkflow(($container->privates['debug.state_machine.envio'] ?? self::getDebug_StateMachine_EnvioService($container)), new \Symfony\Component\Workflow\SupportStrategy\InstanceOfSupportStrategy('App\\Envio\\Entity\\Envio'));
        $f = ($container->privates['Symfony\\Component\\Mercure\\HubRegistry'] ?? self::getHubRegistryService($container));
        ...
        $i->setDebug(true);
        $i->setTokenStorage(($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'doctrine.dbal.connection_factory.types' => [
                'encrypted_string' => [
                    'class' => 'App\\Shared\\Doctrine\\Type\\EncryptedStringType',
                ],
            ],
