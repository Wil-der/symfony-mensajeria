...
class getMessenger_Transport_AsyncService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['messenger.transport.async'] = $a->createTransport($container->getEnv('string:REDIS_URL').'/mensajeria_async', ['stream' => 'mensajeria_async', 'group' => 'symfony_group', 'consumer' => 'symfony_consumer', 'transport_name' => 'async'], ($container->privates['messenger.transport.native_php_serializer'] ??= new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer()));
    }
}
